...
lab:
	...
	dput -u smurf "$$F"
	echo -n "Waiting for archive /daten/debian/pool/main/h/homevent/$$(basename "$$F") "; while test ! -f "/daten/debian/pool/main/h/homevent/$$(basename "$$F")" ; do echo -n "."; sleep 1;done;echo " done."
