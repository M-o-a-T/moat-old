...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserForGroup.level'
        db.add_column('rainman_userforgroup', 'level', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserForGroup.level'
        db.delete_column('rainman_userforgroup', 'level')
