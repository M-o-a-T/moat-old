...
class Migration(SchemaMigration):
	# This doesn't actually do anything; it only records the "changed" schema.
    ...
    models = {
        ...
        'rainman.envitem': {
            'Meta': {'object_name': 'EnvItem'},
            'factor': ('django.db.models.fields.FloatField', [], {'default': '1.0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': "orm['rainman.EnvGroup']"}),
        ...
        'rainman.envgroup': {
            'Meta': {'unique_together': "(('site', 'name'),)", 'object_name': 'EnvGroup'},
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'factor': ('django.db.models.fields.FloatField', [], {'default': '1.0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'rainman.valve': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'envgroup': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'valves'", 'to': "orm['rainman.EnvGroup']"}),
