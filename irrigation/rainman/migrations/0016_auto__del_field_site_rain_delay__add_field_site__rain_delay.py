...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Site.rain_delay'
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Site.rain_delay'
        db.add_column('rainman_site', 'rain_delay', self.gf('django.db.models.fields.TimeField')(default=300), keep_default=False)
    ...
    models = {
        ...
        'rainman.rainmeter': {
            ...
            'flag_only': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
