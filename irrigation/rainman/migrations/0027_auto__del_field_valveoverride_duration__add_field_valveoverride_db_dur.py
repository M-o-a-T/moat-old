...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ValveOverride.duration'
        db.delete_column('rainman_valveoverride', 'duration')

        # Adding field 'ValveOverride.db_duration'
        db.add_column('rainman_valveoverride', 'db_duration',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_column='duration'),
                      keep_default=False)

        # Deleting field 'GroupOverride.duration'
        db.delete_column('rainman_groupoverride', 'duration')

        # Adding field 'GroupOverride.db_duration'
        db.add_column('rainman_groupoverride', 'db_duration',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_column='duration'),
                      keep_default=False)

        # Deleting field 'Schedule.duration'
        db.delete_column('rainman_schedule', 'duration')

        # Adding field 'Schedule.db_duration'
        db.add_column('rainman_schedule', 'db_duration',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_column='duration'),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ValveOverride.duration'
        raise RuntimeError("Cannot reverse this migration. 'ValveOverride.duration' and its values cannot be restored.")
        # Deleting field 'ValveOverride.db_duration'
        db.delete_column('rainman_valveoverride', 'duration')


        # User chose to not deal with backwards NULL issues for 'GroupOverride.duration'
        raise RuntimeError("Cannot reverse this migration. 'GroupOverride.duration' and its values cannot be restored.")
        # Deleting field 'GroupOverride.db_duration'
        db.delete_column('rainman_groupoverride', 'duration')


        # User chose to not deal with backwards NULL issues for 'Schedule.duration'
        raise RuntimeError("Cannot reverse this migration. 'Schedule.duration' and its values cannot be restored.")
        # Deleting field 'Schedule.db_duration'
        db.delete_column('rainman_schedule', 'duration')
