...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ValveOverride.name'
        db.alter_column('rainman_valveoverride', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'GroupOverride.name'
        db.alter_column('rainman_groupoverride', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ValveOverride.name'
        raise RuntimeError("Cannot reverse this migration. 'ValveOverride.name' and its values cannot be restored.")
        # Adding unique constraint on 'ValveOverride', fields ['valve', 'name']
        db.create_unique('rainman_valveoverride', ['valve_id', 'name'])


        # User chose to not deal with backwards NULL issues for 'GroupOverride.name'
        raise RuntimeError("Cannot reverse this migration. 'GroupOverride.name' and its values cannot be restored.")
    ...
    models = {
        ...
        'rainman.log': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 0, 0)', 'db_index': 'True'}),
        ...
        'rainman.valve': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 0, 0)', 'db_index': 'True'}),
            'var': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
