...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Log.valve'
        db.alter_column('rainman_log', 'valve_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rainman.Valve']))

        # Changing field 'Log.controller'
        db.alter_column('rainman_log', 'controller_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rainman.Controller']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Log.valve'
        raise RuntimeError("Cannot reverse this migration. 'Log.valve' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Log.controller'
        raise RuntimeError("Cannot reverse this migration. 'Log.controller' and its values cannot be restored.")
