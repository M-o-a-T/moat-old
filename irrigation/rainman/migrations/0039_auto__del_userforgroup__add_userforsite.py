...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserForSite'
        db.create_table('rainman_userforsite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('level', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
        ))
        db.send_create_signal('rainman', ['UserForSite'])

        # Adding M2M table for field sites on 'UserForSite'
        db.create_table('rainman_userforsite_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userforsite', models.ForeignKey(orm['rainman.userforsite'], null=False)),
            ('site', models.ForeignKey(orm['rainman.site'], null=False))
        ))
        db.create_unique('rainman_userforsite_sites', ['userforsite_id', 'site_id'])

        # Adding M2M table for field valves on 'UserForSite'
        db.create_table('rainman_userforsite_valves', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userforsite', models.ForeignKey(orm['rainman.userforsite'], null=False)),
            ('valve', models.ForeignKey(orm['rainman.valve'], null=False))
        ))
        db.create_unique('rainman_userforsite_valves', ['userforsite_id', 'valve_id'])

    def backwards(self, orm):
        # Adding model 'UserForGroup'
        db.create_table('rainman_userforgroup', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', null=True, to=orm['rainman.Group'], blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('level', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('rainman', ['UserForGroup'])

        # Deleting model 'UserForSite'
        db.delete_table('rainman_userforsite')

        # Removing M2M table for field sites on 'UserForSite'
        db.delete_table('rainman_userforsite_sites')

        # Removing M2M table for field valves on 'UserForSite'
        db.delete_table('rainman_userforsite_valves')
    ...
    models = {
        ...
        'rainman.log': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 27, 0, 0)', 'db_index': 'True'}),
