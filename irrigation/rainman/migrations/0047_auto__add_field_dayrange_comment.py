...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DayRange.comment'
        db.add_column('rainman_dayrange', 'comment',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DayRange.comment'
        db.delete_column('rainman_dayrange', 'comment')
    ...
    models = {
        ...
        'rainman.log': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 6, 0, 0)', 'db_index': 'True'}),
        ...
        'rainman.valve': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 6, 0, 0)', 'db_index': 'True'}),
            'var': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
