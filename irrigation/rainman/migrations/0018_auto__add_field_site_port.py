...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rainman_site', 'port', self.gf('django.db.models.fields.PositiveIntegerField')(default=50005), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.port'
        db.delete_column('rainman_site', 'port')
