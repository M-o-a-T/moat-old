...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'History.temp'
        db.alter_column('rainman_history', 'temp', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'History.sun'
        db.alter_column('rainman_history', 'sun', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'History.wind'
        db.alter_column('rainman_history', 'wind', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'History.temp'
        raise RuntimeError("Cannot reverse this migration. 'History.temp' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'History.sun'
        raise RuntimeError("Cannot reverse this migration. 'History.sun' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'History.wind'
        raise RuntimeError("Cannot reverse this migration. 'History.wind' and its values cannot be restored.")
