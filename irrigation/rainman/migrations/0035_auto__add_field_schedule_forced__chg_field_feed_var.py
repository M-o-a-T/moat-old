...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Schedule.forced'
        db.add_column('rainman_schedule', 'forced',
                      self.gf('django.db.models.fields.BooleanField')(default=False, max_length=1),
                      keep_default=False)


        # Changing field 'Feed.var'
        db.alter_column('rainman_feed', 'var', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True))
    def backwards(self, orm):
        # Deleting field 'Schedule.forced'
        db.delete_column('rainman_schedule', 'forced')


        # Changing field 'Feed.var'
        db.alter_column('rainman_feed', 'var', self.gf('django.db.models.fields.CharField')(default='', max_length=200, unique=True))
    models = {
        'auth.group': {
        ...
        'rainman.log': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 0)', 'db_index': 'True'}),
