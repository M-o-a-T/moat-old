...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.db_max_flow_wait'
        db.add_column('rainman_feed', 'db_max_flow_wait', self.gf('django.db.models.fields.PositiveIntegerField')(default=300, db_column='max_flow_wait'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.db_max_flow_wait'
        db.delete_column('rainman_feed', 'max_flow_wait')
