...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EnvironmentEffect'
        db.create_table('rainman_environmenteffect', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='environment_effects', to=orm['rainman.Site'])),
            ('factor', self.gf('django.db.models.fields.FloatField')()),
            ('temp', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('wind', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('sun', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('rainman', ['EnvironmentEffect'])


    def backwards(self, orm):
        
        # Deleting model 'EnvironmentEffect'
        db.delete_table('rainman_environmenteffect')
