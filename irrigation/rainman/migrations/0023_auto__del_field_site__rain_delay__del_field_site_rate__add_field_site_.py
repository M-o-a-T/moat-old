...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Site._rain_delay'
        db.delete_column('rainman_site', '_rain_delay')

        # Deleting field 'Site.rate'
        db.delete_column('rainman_site', 'rate')

        # Adding field 'Site.db_rate'
        db.add_column('rainman_site', 'db_rate', self.gf('django.db.models.fields.FloatField')(default=2, db_column='rate'), keep_default=False)

        # Adding field 'Site.db_rain_delay'
        db.add_column('rainman_site', 'db_rain_delay', self.gf('django.db.models.fields.PositiveIntegerField')(default=300, db_column='rain_delay'), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Site._rain_delay'
        db.add_column('rainman_site', '_rain_delay', self.gf('django.db.models.fields.PositiveIntegerField')(default=300), keep_default=False)

        # Adding field 'Site.rate'
        db.add_column('rainman_site', 'rate', self.gf('django.db.models.fields.FloatField')(default=2), keep_default=False)

        # Deleting field 'Site.db_rate'
        db.delete_column('rainman_site', 'rate')

        # Deleting field 'Site.db_rain_delay'
        db.delete_column('rainman_site', 'rain_delay')
