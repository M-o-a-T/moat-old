...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Valve.location'
        db.add_column('rainman_valve', 'location', self.gf('django.db.models.fields.CharField')(default='dud', max_length=200), keep_default=False)

        if not db.dry_run:
            for valve in orm.Valve.objects.all():
                valve.location = valve.comment
                valve.save()


    def backwards(self, orm):
        
        # Deleting field 'Valve.location'
        db.delete_column('rainman_valve', 'location')
