...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Level.forced'
        db.add_column('rainman_level', 'forced',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Level.forced'
        db.delete_column('rainman_level', 'forced')
    ...
    models = {
        ...
        'rainman.log': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 0, 0)', 'db_index': 'True'}),
