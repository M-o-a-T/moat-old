...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rainman_feed', 'disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.disabled'
        db.delete_column('rainman_feed', 'disabled')
    ...
    models = {
        ...
        'rainman.feed': {
            ...
            'disabled': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'max_length': '1'}),
        ...
        'rainman.log': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 11, 0, 0)', 'db_index': 'True'}),
        ...
        'rainman.valve': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 11, 0, 0)', 'db_index': 'True'}),
            'var': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
