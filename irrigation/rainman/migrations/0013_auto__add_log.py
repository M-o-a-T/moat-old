...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Log'
        db.create_table('rainman_log', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('logger', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['rainman.Site'])),
            ('controller', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['rainman.Controller'])),
            ('valve', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['rainman.Valve'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('rainman', ['Log'])


    def backwards(self, orm):
        
        # Deleting model 'Log'
        db.delete_table('rainman_log')
    ...
    models = {
        ...
        'rainman.log': {
            ...
            'controller': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'logs'", 'to': "orm['rainman.Controller']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'valve': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'logs'", 'to': "orm['rainman.Valve']"})
        },
        'rainman.rainmeter': {
