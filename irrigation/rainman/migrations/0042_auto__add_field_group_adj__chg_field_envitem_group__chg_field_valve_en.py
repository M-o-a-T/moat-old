...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.adj'
        db.add_column('rainman_group', 'adj',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Group.adj'
        db.delete_column('rainman_group', 'adj')
    ...
    models = {
        ...
        'rainman.log': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 30, 0, 0)', 'db_index': 'True'}),
        ...
        'rainman.valve': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 30, 0, 0)', 'db_index': 'True'}),
            'var': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
