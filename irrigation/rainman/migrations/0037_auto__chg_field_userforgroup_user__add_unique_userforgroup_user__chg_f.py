...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserForGroup.user'
        db.alter_column('rainman_userforgroup', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'UserForGroup', fields ['user']
        #db.create_unique('rainman_userforgroup', ['user_id'])

        # Changing field 'UserForGroup.group'
        db.alter_column('rainman_userforgroup', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rainman.Group']))
    def backwards(self, orm):
        # Removing unique constraint on 'UserForGroup', fields ['user']
        db.delete_unique('rainman_userforgroup', ['user_id'])


        # Changing field 'UserForGroup.user'
        db.alter_column('rainman_userforgroup', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # User chose to not deal with backwards NULL issues for 'UserForGroup.group'
        raise RuntimeError("Cannot reverse this migration. 'UserForGroup.group' and its values cannot be restored.")
    models = {
        'auth.group': {
        ...
        'rainman.log': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 24, 0, 0)', 'db_index': 'True'}),
        ...
        'rainman.userforgroup': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'users'", 'null': 'True', 'to': "orm['rainman.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
