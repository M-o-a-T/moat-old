...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserForGroup'
        db.create_table('rainman_userforgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', to=orm['rainman.Group'])),
        ))
        db.send_create_signal('rainman', ['UserForGroup'])

        # Adding field 'ValveOverride.on_level'
        db.add_column('rainman_valveoverride', 'on_level', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'ValveOverride.off_level'
        db.add_column('rainman_valveoverride', 'off_level', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'GroupOverride.on_level'
        db.add_column('rainman_groupoverride', 'on_level', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'GroupOverride.off_level'
        db.add_column('rainman_groupoverride', 'off_level', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'UserForGroup'
        db.delete_table('rainman_userforgroup')

        # Deleting field 'ValveOverride.on_level'
        db.delete_column('rainman_valveoverride', 'on_level')

        # Deleting field 'ValveOverride.off_level'
        db.delete_column('rainman_valveoverride', 'off_level')

        # Deleting field 'GroupOverride.on_level'
        db.delete_column('rainman_groupoverride', 'on_level')

        # Deleting field 'GroupOverride.off_level'
        db.delete_column('rainman_groupoverride', 'off_level')
