...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'History.feed'
        db.add_column('rainman_history', 'feed', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'History.feed'
        db.delete_column('rainman_history', 'feed')
    ...
    models = {
        ...
        'rainman.history': {
            ...
            'feed': ('django.db.models.fields.FloatField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
