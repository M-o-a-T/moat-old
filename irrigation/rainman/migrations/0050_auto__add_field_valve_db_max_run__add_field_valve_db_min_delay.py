...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Valve.db_max_run'
        db.add_column('rainman_valve', 'db_max_run',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, db_column='max_run', blank=True),
                      keep_default=False)

        # Adding field 'Valve.db_min_delay'
        db.add_column('rainman_valve', 'db_min_delay',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, db_column='min_delay', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Valve.db_max_run'
        db.delete_column('rainman_valve', 'max_run')

        # Deleting field 'Valve.db_min_delay'
        db.delete_column('rainman_valve', 'min_delay')
    ...
    models = {
        ...
        'rainman.feed': {
            ...
            'flow': ('django.db.models.fields.FloatField', [], {'default': '10', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'rainman.groupoverride': {
            'Meta': {'unique_together': "(('group', 'start'),)", 'object_name': 'GroupOverride'},
        ...
        'rainman.log': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 21, 0, 0)', 'db_index': 'True'}),
        ...
        'rainman.valve': {
            ...
            'db_max_run': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'db_column': "'max_run'", 'blank': 'True'}),
            'db_min_delay': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'db_column': "'min_delay'", 'blank': 'True'}),
            ...
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['rainman.Group']", 'db_table': "'rainman_group_valves'", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 21, 0, 0)', 'db_index': 'True'}),
            'var': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
            'verbose': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'})
        },
        'rainman.valveoverride': {
            'Meta': {'unique_together': "(('valve', 'start'),)", 'object_name': 'ValveOverride'},
            'db_duration': ('django.db.models.fields.PositiveIntegerField', [], {'db_column': "'duration'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'off_level': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
