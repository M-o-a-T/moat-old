...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Valve.verbose'
        db.add_column('rainman_valve', 'verbose',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Valve.verbose'
        db.delete_column('rainman_valve', 'verbose')
    ...
    models = {
        ...
        'rainman.log': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 15, 0, 0)', 'db_index': 'True'}),
