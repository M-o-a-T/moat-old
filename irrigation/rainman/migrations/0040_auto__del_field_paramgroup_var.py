...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ParamGroup.var'
        raise RuntimeError("Cannot reverse this migration. 'ParamGroup.var' and its values cannot be restored.")
    models = {
        'auth.group': {
