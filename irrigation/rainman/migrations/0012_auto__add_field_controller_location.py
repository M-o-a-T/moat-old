...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Controller.location'
        db.add_column('rainman_controller', 'location', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Controller.location'
        db.delete_column('rainman_controller', 'location')
