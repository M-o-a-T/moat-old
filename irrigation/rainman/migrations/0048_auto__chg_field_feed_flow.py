...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feed.flow'
        db.alter_column('rainman_feed', 'flow', self.gf('django.db.models.fields.FloatField')(null=True))
    def backwards(self, orm):

        # Changing field 'Feed.flow'
        db.alter_column('rainman_feed', 'flow', self.gf('django.db.models.fields.FloatField')())
    models = {
        'auth.group': {
        ...
        'rainman.log': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 21, 0, 0)', 'db_index': 'True'}),
        ...
        'rainman.valve': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 21, 0, 0)', 'db_index': 'True'}),
            'var': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
